          ...
          <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            <div>
              ...
              <p className="text-sm mt-6 text-gray-800">
                Log in for a smooth shopping experience tailored to your style.
                Access your account to track orders, explore new arrivals, and
                enjoy exclusive offers designed just for you!
              </p>
