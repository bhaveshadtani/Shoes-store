          ...
          <div className="mt-8">
            ...
            <div className="mt-8">
              ...
              <p className="text-sm text-gray-600 mt-4">
                ...
                Designed for comfort and crafted with a contemporary aesthetic,
                these versatile shoes are a must-have addition to your wardrobe.
                The supple and breathable materials ensure all-day comfort,
